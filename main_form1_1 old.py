...
from variables import variable_dict, \
    ...
    stp12_head_font, stp12_l_w2, stp12_l_w1, stp12_e_w_s, stp12_e_w_b, stp12_lable_font, stp12_entry_font, stp12_l_w2m, \
    csv_data_file, no_dash_b_ent, step2_valid, \
...
#restric entry to only number input
...
# Create a labeled frame for "Step1"
step1=tk.LabelFrame(frame_out,text="STEP1",font=stp12_head_font,padx=px,pady=10,)
step1.grid(row=0,column=0,padx=px,pady=10)

name_l=tk.Label(step1,text="Name",width=stp12_l_w1,font=stp12_lable_font)
name_l.grid(row=0,column=0,sticky="w",padx=px,pady=4)
name_e=tk.Entry(step1,width=stp12_e_w_b,font=stp12_entry_font)
name_e.grid(row=0,column=1,padx=px,pady=py,columnspan=3)

part_l=tk.Label(step1,text="Part",width=stp12_l_w1,font=stp12_lable_font)
part_l.grid(column=0,row=1,padx=px,pady=py,sticky="w")
part_e=tk.Entry(step1,width=stp12_e_w_s,font=stp12_entry_font)
part_e.grid(row=1,column=1,padx=px,pady=py)

po_qty_l=tk.Label(step1,text="PO QTY",width=stp12_l_w1,font=stp12_lable_font)
po_qty_l.grid(row=1,column=2,padx=px,pady=py)
po_qty_e= tk.Entry(step1,width=stp12_e_w_s,font=stp12_entry_font)
po_qty_e.grid(row=1,column=3,padx=px,pady=py)

po_no_l=tk.Label(step1,text="PO No",width=stp12_l_w1,font=stp12_lable_font)
po_no_l.grid(column=0,row=2,padx=px,pady=py)
po_no_e=tk.Entry(step1,width=stp12_e_w_s,font=stp12_entry_font)
po_no_e.grid(row=2,column=1,padx=px,pady=py)

shift_l=tk.Label(step1,text="Shift",font=stp12_lable_font,width=stp12_l_w1)
shift_l.grid(row=2,column=2,padx=px,pady=py,sticky="w")
shift_e=tk.Entry(step1,width=stp12_e_w_s,font=stp12_entry_font)
shift_e.grid(row=2,column=3,padx=px,pady=py)

stp1_btn_submit=tk.Button(step1,text="Start Time", font=("Arial", 12,"bold"),command=on_btn1_clk())
stp1_btn_submit.grid(row=3,column=0 ,columnspan=4,pady=10)


# Create a labeled frame for "Parts Details"
step2 = tk.LabelFrame(frame_out, text="STEP 2",font=stp12_head_font,padx=px, pady=10)
step2.grid(row=0, column=1, padx=px, pady=10)
...
good_part_e.grid(row=0, column=1, padx=4, pady=py)

hp_l = tk.Label(step2, text="HP",font=stp12_lable_font,anchor="w",width=stp12_l_w2m)
...
hp_e.grid(row=0, column=3, padx=4, pady=py)

lp_l = tk.Label(step2, text="LP",font=stp12_lable_font,anchor="w",width=stp12_l_w2m)
...
lp_e.grid(row=0, column=5, padx=4, pady=py)
...
reworked_e.grid(row=1, column=1, padx=4, pady=py)

inlt_l = tk.Label(step2, text="INLT",font=stp12_lable_font,anchor="w",width=stp12_l_w2m)
inlt_l.grid(row=1, column=2, sticky="w")
inlt_e= tk.Entry(step2,font=stp12_entry_font,width=stp12_e_w_s)
inlt_e.grid(row=1, column=3, padx=4, pady=py)
inlt_e.insert(0,0)

otlt_l = tk.Label(step2, text="OTLT",font=stp12_lable_font,anchor="w",width=stp12_l_w2m)
...
otlt_e.grid(row=1, column=5, padx=4, pady=py)
otlt_e.insert(0,"0")
...
QC_OK_e.grid(row=2, column=1, padx=4, pady=py)

vlv_l = tk.Label(step2, text="VLV",font=stp12_lable_font,anchor="w",width=stp12_l_w2m)
vlv_l.grid(row=2, column=2, sticky="w")
vlv_e= tk.Entry(step2,font=stp12_entry_font,width=stp12_e_w_s)
vlv_e.grid(row=2, column=3, padx=4, pady=py)
vlv_e.insert(0,0)

oth_l = tk.Label(step2, text="OTH",font=stp12_lable_font,anchor="w",width=stp12_l_w2m)
...
oth_e.grid(row=2, column=5, padx=4, pady=py)
oth_e.insert(0,"0")
...
descrptn_frame = tk.LabelFrame(frame_out, padx=px, pady=10)
